...
The synthetic graph is stored in the directory:"./data/DBLP/DBLP_output_sequences.txt" or you can save the 3-d tensor "graph" (3-d adjacency matrix: k X n X n, where k is the number of different timestamp) as the final output synthetic graph after [line 72 in metrics file](https://github.com/davidchouzdw/TagGen/blob/master/metrics.py#L72).
